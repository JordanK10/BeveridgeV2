...
def compare_sine_special():
    ...
    plot_beveridge_comparison(comparison_data, filename="beveridge_signal_comparison.png")
...
def plot_beveridge_comparison(curves_data, filename="beveridge_comparison.png"):
    """
