...
def plot_growth_rates_time_series(demand_signal, total_employment, aggregate_vacancies, economy_name, 
    ...
    # Limit to first 1000 steps for clarity, similar to other time series plots
    llimit = 12000 
    ulimit = 13000 
...
def plot_matching_time_vs_K(K_current=5.4, u_min=0.05, u_max=0.15, output_dir=None):
    """
...
def plot_matching_time_vs_urate(K_current=5.4, u_min=0.05, u_max=0.15, output_dir=None):
    """
    ...
    K_specs = [
        (1.0/6.0, 'K = 1/6'),
        (K_current, f'K = {K_current:.1f} (current)'),
